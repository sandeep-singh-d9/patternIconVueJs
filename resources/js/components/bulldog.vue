  ...
  <div>
      <svg  version="1.1" baseProfile="basic" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="display: none;">
       <symbol :id="'ic'+this.ValueId">
        <g class="icon">     
            <path
            :style="{fill:'rgba('+this.getterBg1+')' }" :class="this.ValueId+'_color1'"
        ...
        c0-51.564-41.801-93.364-93.365-93.364s-93.364,41.8-93.364,93.364v86.505C62.184,292.318,80.962,311.096,103.912,311.096z"
            />
            <path
            :style="{fill:'rgba('+this.getterBg3+')' }" :class="this.ValueId+'_color3'"
        ...
        C83.877,222.392,74.651,211.103,62.184,207.95z"
            ...
            />
            <path
            :style="{fill:'rgba('+this.getterBg2+')' }" :class="this.ValueId+'_color2'"
    ...
    <use :class="this.ValueId" :href="'#ic'+this.ValueId" x="0" y="0" />
     ...
     <!-- for button -->
      <button :style="{background:'rgba('+this.getterBg1+')' , width:'50px' ,height:'50px'}" @click="ShowElement(getterBg1)" :class="this.ValueId+'_color1btn'"></button>
               
               
    <button :style="{backgroundColor:'rgba('+this.getterBg2+')' , width:'50px' , height:'50px'}" @click="ShowElement1(getterBg2)" :class="this.ValueId+'_color2btn'"></button>
    
    
    <button :style="{backgroundColor:'rgba('+this.getterBg3+')' , width:'50px' , height:'50px'}" @click="ShowElement2(getterBg3)" :class="this.ValueId+'_color3btn'"></button>
