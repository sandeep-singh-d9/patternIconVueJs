<template>
  <div class="editor">
      <svg x="0px" y="0px" width="100%" height="100%" xmlSpace="preserve" class="icon " >
        ...
        <g class="icon">     
            <path
            :style="{fill:'rgba('+this.$store.state.background+')' }"
        ...
        c0-51.564-41.801-93.364-93.365-93.364s-93.364,41.8-93.364,93.364v86.505C62.184,292.318,80.962,311.096,103.912,311.096z"
            />
            <path
            :style="{fill:'rgba('+this.$store.state.background1+')' }"
        ...
        C83.877,222.392,74.651,211.103,62.184,207.95z"
            ...
            />
            <path
            :style="{fill:'rgba('+this.$store.state.background2+')' }"
    ...
    <button @click="getElement($event)">Save</button>
  </div>
</template>
...
export default {
   mounted(){
    //    alert(this.$store.state.background)
   },
   computed:{
        data:{
            get(){
    ...
    methods:{
        ...
        getElement(e){
            ...
            this.ACTION_CHANGE_STATE(['urlSvg', ''])
        }
    }
}
</script>
