    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                   <path  :style="{fill:'rgba(14, 14, 14, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M70.7,74c47,0.2,92.6,9,137.8,21.2c11.3,3,22.8,5.2,34.3,7.3c14.5,2.7,28.1-1,41.6-6.1
...
<path  :style="{fill:'rgba(227, 94, 45, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M176.6,106.6c16.6,3.9,32.4,7.4,48.1,11.5c25.6,6.7,50.1,3.5,74-7.2c1.7-0.8,3.6-1.4,5.3-2.3
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterWormBg1+')'}" @click="ShowElement(getterWormBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterWormBg2+')'}" @click="ShowElement1(getterWormBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <!-- <button :style="{backgroundColor:'rgba('+getterWormBg3+')'}" @click="ShowElement2(getterWormBg3)" :class="this.ValueId+'_color3btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterWormBg4+')'}" @click="ShowElement3(getterWormBg4)" :class="this.ValueId+'_color4btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterWormBg5+')'}" @click="ShowElement4(getterWormBg5)" :class="this.ValueId+'_color5btn'"></button>

                                    <button :style="{backgroundColor:'rgba('+getterWormBg6+')'}" @click="ShowElement5(getterWormBg6)" :class="this.ValueId+'_color6btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterWormBg7+')'}" @click="ShowElement6(getterWormBg7)" :class="this.ValueId+'_color7btn'"></button> -->
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            var randomNumber = Worm[this.$store.state.randomIndexElement].left
            var randomNumberTop  =  Worm[this.$store.state.randomIndexElement].top
            if(this.$store.state.randomFirstSvg == 'Worm'){
            ...
            ...mapState([
                ...
                getterWormBg1: {
                    get() {
                        ...
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'Worm') {
