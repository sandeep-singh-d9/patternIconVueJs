    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                   <path  :style="{fill:'rgba(0, 118, 190, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color4'" d="M455.1,472.8c-36,0.1-71.9,0.1-107.9,0.2c-16.7,0-33.3,0-50,0c-17.7,0-32.1-14.2-32.2-31.9
...
<path :style="{fill:'rgba(233, 197, 186, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color7'" d="M265.2,311.1c22.6,0,45.1-2.4,67.6-3.3c16.9-0.7,33.7-2.5,50.7-2.7c8.9-0.1,15.5,4.9,17.3,12.8
...
<path  :style="{fill:'rgba(0, 162, 224, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color5'" d="M455.1,472.8c10.7-3.2,19-9,23.4-19.7c1.7-4.2,2.5-8.5,2.5-13.1c0-82.1,0-164.2,0-246.3
...
<path  :style="{fill:'rgba(227, 42, 23, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color6'" d="M49.1,401c0,0.7-0.2,1.3-0.1,2c0.9,13-3.5,14.5-14,14c-6.8-0.3-13.7-0.4-20.5,0.1
...
<path  :style="{fill:'rgba(253, 203, 102, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M361,73c-12.3,0-24.6,0.1-37-0.1c-3.3,0-5.6,1-7.9,3.3c-5.2,5.4-10.5,10.7-15.9,15.9
...
<path  :style="{fill:'rgba(253, 203, 102, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M49.1,401c0-45.4,0-90.7,0-136.1c7.6,0,15.2,0,22.7,0c5.9,0,8.1,2,9.1,8c0,41,0,81.9,0,122.9
	c-2.6,4.1-6.2,5.4-11,5.1C63.1,400.8,56.1,401,49.1,401z"/>
<path  :style="{fill:'rgba(255, 125, 157, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color3'" d="M200.9,257c-23.8,0-38.6-23.8-28.3-45.2c6.8-14.2,16.1-26.6,25.4-39.2c2.2-3,4.2-2.6,6.2,0.1
	c9.1,12.4,17.9,25,25.2,38.7C240.8,233.2,223,257.7,200.9,257z"/>
<path  :style="{fill:'rgba(229, 184, 94, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M361,73c16,0,32,0,48,0c0,21.3,0,42.7,0,64c-1.7,1.7-3.9,1.6-6.1,1.6c-12,0.1-23.9,0.1-35.9,0
	c-2.1,0-4.4,0.1-6.1-1.6C361,115.7,361,94.3,361,73z"/>
<path  :style="{fill:'rgba(255, 125, 157, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color3'" d="M361,137c16,0,32,0,48,0c9,0,18,0.2,26.9-0.1c3.8-0.1,5.4,0.8,5.1,5c-0.3,6.3-0.1,12.6,0,18.9
	c-37.4,0-74.7,0-112.1,0c0-6.5,0.2-13,0-19.5c-0.1-3.6,1.2-4.5,4.6-4.5C342.7,137.1,351.8,137,361,137z"/>
<path :style="{fill:'rgba(210, 176, 168, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color8'" d="M263.9,312.1c2.5,17.7-15.8,33.6-32.5,33.1c-24.4-0.8-48.9-0.2-73.4-0.2c-6.1,0-10-3.1-10-8
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterHandsoapBg1+')'}" @click="ShowElement(getterHandsoapBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg2+')'}" @click="ShowElement1(getterHandsoapBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg3+')'}" @click="ShowElement2(getterHandsoapBg3)" :class="this.ValueId+'_color3btn'"></button>

                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg4+')'}" @click="ShowElement3(getterHandsoapBg4)" :class="this.ValueId+'_color4btn'"></button>

                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg5+')'}" @click="ShowElement4(getterHandsoapBg5)" :class="this.ValueId+'_color5btn'"></button>
                                    
                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg6+')'}" @click="ShowElement5(getterHandsoapBg6)" :class="this.ValueId+'_color6btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg7+')'}" @click="ShowElement6   (getterHandsoapBg7)" :class="this.ValueId+'_color7btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterHandsoapBg8+')'}" @click="ShowElement7(getterHandsoapBg8)" :class="this.ValueId+'_color8btn'"></button>
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            var randomNumber = Handsoap[this.$store.state.randomIndexElement].left
            var randomNumberTop  =  Handsoap[this.$store.state.randomIndexElement].top
            if(this.$store.state.randomFirstSvg == 'Handsoap'){
            ...
            ...mapState([
                ...
                getterHandsoapBg1: {
                    get() {
                        ...
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'Handsoap') {
