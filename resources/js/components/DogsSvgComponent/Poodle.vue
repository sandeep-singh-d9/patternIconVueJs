    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                    <path :style="{fill:'rgba(0, 0, 0, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color3'" d="M296.1,201.9c-2-1.7-4.1-3.1-5.7-4.9c-6.7-7.9-7.4-18.2-1.7-27c1.8-2.7,1.7-4.5,0.4-7.3c-8.3-17.5-3.8-37.6,11.2-50
...
<g>
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M295.4,508.6c9-18.9-0.6-37.9-21.1-41.1c-4.9-0.8-5-2.4-3.8-6.2c1.7-5.8-0.3-10.8-4.9-14.5
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M429.8,376.1c15.9-4.3,23.7-24,15-39.1c-2.5-4.4-1.9-6.3,1.7-9.4c10.2-8.6,13.9-20.5,16-33.3
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M126.6,434.9c10.1-6,15.3-17.3,12.9-29.4c-0.7-3.5,0.9-4.2,3.4-5.4c8-3.7,12.2-11.1,11.3-19.2
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M300,171.3c-5,3.6-6.9,8.8-5,14.9c1.9,6,6.3,9.1,12.4,10c2.8,0.4,5.6,0.4,8.7,1.8
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M507.3,297.8c-2.4-2-2.8-3.5-1.8-6.3c2.9-7.7,3.4-15.8,2.3-25.3c-8,15.2-17.2,20.1-33,17.8
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M521.8,171c-3-2.1-3-3.5-0.9-6.3c6.2-8.4,8.7-17.6,5.6-28c-1.5-6.9-5.2-12.3-10.8-17
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M456.9,461c-3.5,4.9-5.2,4-8.7,0.4c-4.3-4.3-10.5-4.7-15.6-2c-5.1,2.7-8.5,8.6-7.2,14.1
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M377.4,461.1c-3.2,4.5-4.8,4.3-8.3,0.6c-4.3-4.6-10.8-5.1-16.1-2.2c-5.4,3-8.5,9.1-6.8,15.3
	...
	<path :style="{fill:'rgba(238, 229, 214, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color1'" d="M314.5,96c-5.1,14.8,3.3,31.4,17.1,34.2c-0.7-15.8,5.7-28,18.7-36.8c9.3-3.9,18.8-6.2,28.8-3
...
<path style="fill:#FEFEFE;transform:scale(0.2)" d="M411.5,495c2.9,9.2,7.7,15,15.7,17.5c2.2,0.7,2.6,1.8,2.6,3.7c-0.1,8.1-0.1,16.3,0,24.4
...
<path style="fill:#EFE6D8;transform:scale(0.2)" d="M314.1,583.9c-5.1,1.6-6.1-1.5-5.8-6.5c0.4-6-0.2-12.1,0.1-18.1c0.2-3.9-2-3.5-4.4-3.4
...
<path style="fill:#EFE6D8;transform:scale(0.2)" d="M430.2,583.9c-9.3,0-10.3-1.2-9.8-10.6c0.9-15.5,16-27.8,32.5-26.8c16.4,1.1,29.2,15,28.1,30.6
...
<path style="fill:#EFE6D8;transform:scale(0.2)" d="M398.8,583.6c-6.2,1.9-6.7-1.6-6.5-6.4c0.3-6-0.2-12.1,0.1-18.1c0.2-4.5-2.9-3.1-5.1-3.2
...
<path style="fill:#FEFDFD;transform:scale(0.2)" d="M418.4,460.9c-4.4-8.2-10.3-13.9-19-16.1c-1.9-0.5-2.4-1.5-2.4-3.3c0-10.7,0.1-21.4,0-32.1
...
<path style="fill:#F1E8DA;transform:scale(0.2)" d="M479.9,131.3c-1,12-12.3,22.1-25.3,22.8c-12.7,0.7-25.8-8.5-28.2-19.8c-0.2-1.1-1.3-3.3,0.8-3.2
	c3,0.2,6.6-2.2,9,2.5c4.9,9.9,14.4,13.6,23.7,10c3.7-1.5,6.7-3.9,8.9-7.2C472.5,130.5,472.6,130.5,479.9,131.3z"/>
<path style="fill:#F2E8DB;transform:scale(0.2)" d="M369.1,154.3c-11.7-0.7-20.6-6-25.5-17c-0.8-1.8-3.8-5-0.1-6.1c2.6-0.8,6.5-2.1,8.8,2.6
...
<g>
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M451.6,163.6c-7.7-0.1-14.3-3.2-20.7-7.1c-19.6-17.4-20.2-35.7-1.4-60.5
	...
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M321.7,402.1c-1-1.2-2.1-1.4-3.6-1.1c-11,2.3-19.3-1.8-25.4-10.9c0,0,0,0,0,0c0,0,0,0,0,0
	...
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M387.8,427.4c0-1,0-1.9,0-2.9c0-4.8-0.2-9.7,0.1-14.5c0.1-3.3-0.6-5.4-4.2-6.3
	...
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M391.7,121.6c4.4,0.1,4.9-1.5,3.5-5.2c-4-10.7-14.6-18.2-26-18.2c-11.5,0-21.9,7.3-26.1,18
		c-1.7,4.2-0.6,5.5,3.8,5.4c7.4-0.2,14.7-0.1,22.1-0.1C376.5,121.5,384.1,121.4,391.7,121.6z"/>
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M479.4,116.8c-3.6-10.7-14.7-18.6-26.3-18.6c-11.6,0-22.7,8-26.3,18.7c-1.3,3.7-0.1,4.8,3.6,4.7
		c7.6-0.2,15.1-0.1,22.7-0.1c7.6,0,15.1-0.1,22.7,0.1C479.7,121.7,480.7,120.5,479.4,116.8z"/>
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M462.5,431.8c0-3.7-0.2-7.4,0-11.1c0.2-3.1-1-4-4.1-3.8c-4.4,0.3-8.9,0.6-13.1-1.5
	...
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M455.1,514.8c-1.4-0.3-2.7-1.5-3.7-2.7c-2.1-2.4-3.9-2.1-6.9-1c-4.9,1.7-5.8,4.6-5.4,9.1
		...
		z"/>
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M384,518.2c-4.8-1.2-9.2-2.9-12.8-6.5c-1-1-1.9-2.6-3.9-1.4c-1.7,1.1-3.1,2-3,4.5
	...
	<path :style="{fill:'rgba(203, 166, 124, 1)' ,transform: 'scale(0.2)' }" :class="ValueId+'_color2'" d="M89.3,495.8c-5.3-15.7-4.8-31.6-1.7-48c-3,0.5-4.1,1.9-4.5,4c-3.1,14.9-4.6,29.9-1.1,44.9
		c2.6,11.2,7.9,21,15.6,29.5c0.8,0.9,2.3,3.5,3.4,1c1.3-3.1,3.5-6.4,0.1-10.2C95.5,511,91.9,503.6,89.3,495.8z"/>
</g>
<path style="transform:scale(0.2)" d="M411.1,266.3c-5,0-11.2-4-11.3-7.4c-0.1-5.4,7.3-15.6,11.3-15.6c4,0,11.4,10.3,11.3,15.6
	C422.3,262.2,416.1,266.3,411.1,266.3z"/>
<path style="fill:#E2DCCA;transform:scale(0.2)" d="M358.5,279c-0.1,6.2-3.9,6-8.3,4.8C353,282.2,355.7,280.6,358.5,279z"/>
<path style="fill:#E2DCCA;transform:scale(0.2)" d="M348.1,284.1c-0.4,2.7-2.4,3.8-4.8,3.8c-1.4,0-1-1.7-1.1-2.8C344.1,284.8,346.1,284.5,348.1,284.1z"
	/>
                </g>
        </svg>
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterPoodleBg1+')'}" @click="ShowElement(getterPoodleBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterPoodleBg2+')'}" @click="ShowElement1(getterPoodleBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterPoodleBg3+')'}" @click="ShowElement2(getterPoodleBg3)" :class="this.ValueId+'_color3btn'"></button>

                                    <!-- <button :style="{backgroundColor:'rgba('+getterPoodleBg4+')'}" @click="ShowElement3(getterPoodleBg4)" :class="this.ValueId+'_color4btn'"></button>

                                    <button :style="{backgroundColor:'rgba('+getterPoodleBg5+')'}" @click="ShowElement4(getterPoodleBg5)" :class="this.ValueId+'_color5btn'"></button> -->
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            var randomNumber = Poodle[this.$store.state.randomIndexElement].left
            var randomNumberTop  =  Poodle[this.$store.state.randomIndexElement].top
            if(this.$store.state.randomFirstSvg == 'Poodle'){
            ...
            ...mapState([
                ...
                getterPoodleBg1: {
                    get() {
                        ...
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'Poodle') {
