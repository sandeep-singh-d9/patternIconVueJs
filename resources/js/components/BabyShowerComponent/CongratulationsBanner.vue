    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                  <path style="fill:#AB72C1; transform:scale(0.2)" :class="ValueId+'_color1'" d="M165.3,224c2.3,0.3,4.4,1.3,6.5,2.3c4.4,2.2,8.2,5.1,11.2,9c0.8,1,1.5,1.2,2.7,0.9
...
<path style="fill:#AB72C1; transform:scale(0.2)" :class="ValueId+'_color1'" d="M190,95c-1.8-0.9-3.6-1.8-5.4-2.8c-2.2-1.2-4.3-1-6.4,0.1c-1.6,0.8-3.1,1.7-4.7,2.5
...
<path style="fill:#30309A; transform:scale(0.2)" :class="ValueId+'_color2'" d="M130.6,49.9c-0.7,1.4-1.8,2.5-2.6,3.8c-1.5,2.4-2.6,4.9-3.1,7.6c-0.9,4.2,0.4,7.9,2.9,11.3
...
<path style="fill:#824C97; transform:scale(0.2)" :class="ValueId+'_color3'" d="M450.5,142.8c2-4.5,5-8.2,9.3-10.6c4.5-2.6,9.3-3,14.3-1.8c3.9,0.9,7.3,2.7,10.1,5.6
...
<path style="fill:#AB72C1; transform:scale(0.2)" :class="ValueId+'_color1'" d="M290.9,224.2c-2.1-0.2-3.9-1.1-5.7-2c-3.9-2-7.3-4.5-9.9-8c-0.7-0.9-1.3-1-2.4-0.8
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterCongratulationsBannerBg1+')'}" @click="ShowElement(getterCongratulationsBannerBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterCongratulationsBannerBg2+')'}" @click="ShowElement1(getterCongratulationsBannerBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterCongratulationsBannerBg3+')'}" @click="ShowElement2(getterCongratulationsBannerBg3)" :class="this.ValueId+'_color3btn'"></button>

                                    <!-- <button :style="{backgroundColor:'rgba('+getterCongratulationsBannerBg4+')'}" @click="ShowElement3(getterCongratulationsBannerBg4)" :class="this.ValueId+'_color4btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterCongratulationsBannerBg5 +')'}" @click="ShowElement4(getterCongratulationsBannerBg5 )" :class="this.ValueId+'_color5btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterCongratulationsBannerBg6+')'}" @click="ShowElement5(getterCongratulationsBannerBg6)" :class="this.ValueId+'_color6btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterCongratulationsBannerBg7+')'}" @click="ShowElement6(getterCongratulationsBannerBg7)" :class="this.ValueId+'_color7btn'"></button> -->
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            var randomNumber = CongratulationsBanner[this.$store.state.randomIndexElement].left
            var randomNumberTop  =  CongratulationsBanner[this.$store.state.randomIndexElement].top
            if(this.$store.state.randomFirstSvg == 'CongratulationsBanner'){
        ...
        computed: {
            ...mapState([
                ...
                getterCongratulationsBannerBg1: {
                    get() {
                        // console.log(this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0])
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'CongratulationsBanner') {
                ...
                getterCongratulationsBannerBg2: {
                    get() {
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'CongratulationsBanner') {
                ...
                getterCongratulationsBannerBg3: {
                    get() {
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'CongratulationsBanner') {
                ...
                getterCongratulationsBannerBg4: {
                    get() {
                ...
                getterCongratulationsBannerBg5 : {
                    get() {
                ...
                getterCongratulationsBannerBg6: {
                    get() {
                ...
                getterCongratulationsBannerBg7: {
                    get() {
