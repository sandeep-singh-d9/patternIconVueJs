    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                    <path style="fill:#790000; transform:scale(0.2)" :class="ValueId+'_color1'" d="M518.7,75.9c8.1-0.9,14-5.4,19-11.2c2.8-3.2,4.9-6.8,6.7-10.6c1.7-3.6,4.5-5.4,8.3-4.1
...
<path style="fill:#FFD3B7; transform:scale(0.2)" :class="ValueId+'_color2'" d="M555,146c-5.9,3.9-12,4.5-18.3,1.1c-7.4-3.9-14.3-3.4-21.4,1.2c-11,7.2-22.9,8.5-35.2,3.3
...
<path style="fill:#B75529; transform:scale(0.2)" :class="ValueId+'_color3'" d="M237.5,176.6c2.2,6.9,7.4,11.7,12.5,16.3c11.3,10.3,23.5,19.5,37.6,26c13,5.9,26.5,9.4,40.8,10.6
...
<path style="fill:#B95529; transform:scale(0.2)" :class="ValueId+'_color3'" d="M525.8,48.8c-3.4,12.1-10.5,20.5-22.8,23.8c-4.3,1.2-7,3.8-7.3,8.3c-0.1,2.4,0,5-3,5.3
...
<path style="fill:#790000; transform:scale(0.2)" :class="ValueId+'_color1'" d="M507,113.9c-4.3-0.1-9.2-5.3-9-9.5c0.2-4.1,5.2-8.8,9.2-8.7c4.3,0.1,9.2,5.3,9,9.5
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterBullBg1+')'}" @click="ShowElement(getterBullBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterBullBg2+')'}" @click="ShowElement1(getterBullBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterBullBg3+')'}" @click="ShowElement2(getterBullBg3)" :class="this.ValueId+'_color3btn'"></button>

                                    <!-- <button :style="{backgroundColor:'rgba('+getterBullBg4+')'}" @click="ShowElement3(getterBullBg4)" :class="this.ValueId+'_color4btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterBullBg5+')'}" @click="ShowElement4(getterBullBg5)" :class="this.ValueId+'_color5btn'"></button> -->
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            ...
            if(this.$store.state.randomFirstSvg == 'Bull'){
            ...
            ...mapState([
                ...
                getterBullBg1: {
                    get() {
                        ...
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'Bull') {
