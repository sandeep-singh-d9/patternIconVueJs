    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                   <path style="fill:#790000;transform:scale(0.2)" :class="ValueId+'_color1'" d="M374.6,548c4.8,1,9.5-0.1,14.2,1.2c13.4,3.6,22.3,14.6,22.5,28.4c0.1,6.3,0.1,12.6,0,19
...
<path style="fill:#FCB392;transform:scale(0.2)" :class="ValueId+'_color4'" d="M417.3,401.5c-53.8,0-106.6,0.2-159.4-0.1c-17.9-0.1-32.5-15.8-32.6-33.9
...
<path style="fill:#F6A100;transform:scale(0.2)" :class="ValueId+'_color2'" d="M391.7,585.7c-0.9,2.8-2.9,1.7-4.4,1.7c-14.9,0.1-29.8,0.1-44.6,0.1c-14.5,0-29-0.2-43.4,0.1
...
<path style="fill:#FED3B7;transform:scale(0.2)" :class="ValueId+'_color3'" d="M479.9,309.5c0.2-4.9-1.4-5.1-5.5-4.1c-14,3.5-24.8,11.9-34.2,22.4c-3.4,3.8-7.3,5.5-12.4,5.2
...
<path style="fill:#E2E2E0;transform:scale(0.2)" d="M275,446.2c-0.8,0.4-1.6,0.8-2.5,1.3C273.3,447,274.1,446.5,275,446.2z"/>
<path style="fill:#E2E2E0;transform:scale(0.2)" d="M309.5,499.4c-1.7,0-3,0.1-3.5,2.4c-3.2,15.6-6.6,31.2-9.9,46.6c5.5,0,10.5,0,15.4,0
	c2.1,0,3.7,0.2,4.3-2.8c3.1-15.3,6.5-30.5,9.8-46.2C320,499.4,314.8,499.4,309.5,499.4z"/>
<path style="fill:#790000;transform:scale(0.2)" :class="ValueId+'_color1'" d="M206.2,58.9c9.3,0,9.3,0,9.3,9.1c0,10.5,0,10.5-10.3,10.5c-9.3,0-9.3,0-9.3-9.1
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterGooseBg1+')'}" @click="ShowElement(getterGooseBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterGooseBg2+')'}" @click="ShowElement1(getterGooseBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterGooseBg3+')'}" @click="ShowElement2(getterGooseBg3)" :class="this.ValueId+'_color3btn'"></button>

                                    <button :style="{backgroundColor:'rgba('+getterGooseBg4+')'}" @click="ShowElement3(getterGooseBg4)" :class="this.ValueId+'_color4btn'"></button>

                                    <!-- <button :style="{backgroundColor:'rgba('+getterGooseBg5+')'}" @click="ShowElement4(getterGooseBg5)" :class="this.ValueId+'_color5btn'"></button> -->
                                    <!-- <button :style="{backgroundColor:'rgba('+getterGooseBg6+')'}" @click="ShowElement5(getterGooseBg6)" :class="this.ValueId+'_color6btn'"></button> -->
                                    <!-- <button :style="{backgroundColor:'rgba('+getterGooseBg7+')'}" @click="ShowElement6(getterGooseBg7)" :class="this.ValueId+'_color7btn'"></button> -->
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            var randomNumber = Goose[this.$store.state.randomIndexElement].left
            var randomNumberTop  =  Goose[this.$store.state.randomIndexElement].top
            if(this.$store.state.randomFirstSvg == 'Goose'){
            ...
            ...mapState([
                ...
                getterGooseBg1: {
                    get() {
                        ...
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'Goose') {
