    ...
    <div style="height:0px">
        <svg  @click="getCircle(dynamicIndexValue, $event)" v-for="(items , index) in dataloop" :key="index" version="1.1" baseProfile="basic"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-toggle="modal" :data-target="'#myModal'+dynamicIndexValue"  :style="{transform:'rotate('+sliderValue+'deg) scale('+scaleValue+') scaleX('+flipElement+')'}">
                <g style="transform: scale(0.7);">
                   <path style="fill:#780101;transform:scale(0.2)" :class="ValueId+'_color1'" d="M354.1,268.2c-4.9,12.3-6.3,24.5-1.7,37.2c3.8,10.7,2.9,21.2-3.1,31.3c-7.5,12.5-8.8,26.8-9.4,40.9
...
<path style="fill:#FBD0B5;transform:scale(0.2)" :class="ValueId+'_color2'" d="M390.2,236.3c-6.9,11.3-18.9,12.3-26.1,1.1c-9.5-14.7-16.3-30.6-17.8-48.3c-2.9-2-3.4,1.5-5.1,2.3
	...
	/>
<path style="fill:#FCB392;transform:scale(0.2)" :class="ValueId+'_color3'" d="M347.2,187.1c1,12.1,5,23.3,9.9,34.3c2.5,5.4,4.6,10.9,8.4,15.7c6.5,8.3,13.5,9.1,21.4,2.1
...
<path style="fill:#E1E7F0;transform:scale(0.2)" d="M196.7,320.3c-4.2-7.2-7.2-22.6-6.9-34.8c2.6,6.1,3.7,11.4,4.7,16.8
	C195.4,307.9,195.9,313.6,196.7,320.3z"/>
<path style="fill:#D3DFEF;transform:scale(0.2)" d="M197.2,357.7c2.3,7.1,2.9,13,1.6,19.1C198.3,370.9,196.4,365.1,197.2,357.7z"/>
<path style="fill:#790000;transform:scale(0.2)" d="M51.3,137.2c1.5-8.2,4.5-16.4,7.4-24.7c0.5-1.3,1.7-1.9,3-1.5c1.6,0.5,2.2,1.7,1.8,3.4
                        ...
                        <div class="tab-content">
                            <div :class="{'tab-pane':true, active:ActivePalette=='active'}" id="palette">
                                <div class="bulldog_svg" :id="svgName+dynamicIndex" v-if="this.$store.state.dynamicName ===svgName+dynamicIndex">
                                    <h2>Select Color</h2>
                                    <button :style="{background:'rgba('+getterDonkeyBg1+')'}" @click="ShowElement(getterDonkeyBg1)" :class="this.ValueId+'_color1btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterDonkeyBg2+')'}" @click="ShowElement1(getterDonkeyBg2)" :class="this.ValueId+'_color2btn'"></button>
                                    <button :style="{backgroundColor:'rgba('+getterDonkeyBg3+')'}" @click="ShowElement2(getterDonkeyBg3)" :class="this.ValueId+'_color3btn'"></button>

                                    <!-- <button :style="{backgroundColor:'rgba('+getterDonkeyBg4+')'}" @click="ShowElement3(getterDonkeyBg4)" :class="this.ValueId+'_color4btn'"></button> -->

                                    <!-- <button :style="{backgroundColor:'rgba('+getterDonkeyBg5+')'}" @click="ShowElement4(getterDonkeyBg5)" :class="this.ValueId+'_color5btn'"></button> -->
                                    <!-- <button :style="{backgroundColor:'rgba('+getterDonkeyBg6+')'}" @click="ShowElement5(getterDonkeyBg6)" :class="this.ValueId+'_color6btn'"></button> -->
                                    <!-- <button :style="{backgroundColor:'rgba('+getterDonkeyBg7+')'}" @click="ShowElement6(getterDonkeyBg7)" :class="this.ValueId+'_color7btn'"></button> -->
                                </div>
...
<script>
    ...
    export default {
        ...
        if(this.$store.state.RandomClicked == true){
            var randomNumber = Donkey[this.$store.state.randomIndexElement].left
            var randomNumberTop  =  Donkey[this.$store.state.randomIndexElement].top
            if(this.$store.state.randomFirstSvg == 'Donkey'){
            ...
            ...mapState([
                ...
                getterDonkeyBg1: {
                    get() {
                        ...
                        if (this.$store.state.SvgComponent[this.$store.state.dynamicIndex][0].name === 'Donkey') {
